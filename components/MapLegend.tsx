...
export default function MapLegend() {
  return (
    <div className="absolute bottom-3 left-3 z-[900] bg-white/95 backdrop-blur-sm rounded-lg shadow-md border border-slate-200 px-3 py-2 text-xs text-slate-700 space-y-1.5">
      {ROWS.map(row => (
